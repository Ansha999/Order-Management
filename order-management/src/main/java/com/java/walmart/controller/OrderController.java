...
public class OrderController {
	...
	public List<Orders> getOrdersByCustomerId(@PathVariable String id) {
		return orderService.getOrdersByCustomerId(Integer.parseInt(id));
	}
	...
	public void updateOrder(@RequestBody Orders order) {
		...
		// Should throw exception if the order is not available.
		orderService.saveOrder(order);
	}
